...
def diffie_hellman():
    ...
    if K_A == 0 or K_A == 1:
        print("⚠️ Внимание: общий ключ равен 0 или 1, что небезопасно. Выберите другие параметры.")
    if K_A == YA or K_A == YB:
        print("⚠️ Внимание: общий ключ совпадает с одним из открытых ключей. Выберите другие параметры.")
